...
class LipLinerListModel{
  LipLinerListModel({
    required this.error,
    required this.message,
    required this.count,
    required this.liplinermodels,
  });

  bool error;
  String message;
  int count;
  List<LipLinerModel> liplinermodels;

  factory LipLinerListModel.fromJson(Map<String, dynamic> json) => LipLinerListModel(
    error: json["error"],
    message: json["message"],
    count: json["count"],
    liplinermodels: List<LipLinerModel>.from(json["liplinermodels"].map((x) => LipLinerModel.fromJson(x))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "message": message,
    "count": count,
    "liplinermodels": List<dynamic>.from(liplinermodels.map((x) => x.toJson())),
  };
}
